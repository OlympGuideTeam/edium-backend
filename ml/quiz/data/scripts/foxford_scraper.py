...
Логика агрегации:
- Если текст статьи < 1000 символов — объединяем со следующими статьями из той же темы
- Если накопилось >= 1000 символов — сохраняем чанк
- Если накопилось >= 4000 символов — принудительно сохраняем чанк (потолок)
- Если после всех статей темы всё равно < 1000 символов — пропускаем
