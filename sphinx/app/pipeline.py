...
ВАЖНО: Используй ТОЛЬКО эти типы вопросов:
- single_choice — один правильный ответ из 4 вариантов
- multiple_choice — несколько правильных ответов (2-3) из 4-5 вариантов
- short_answer — краткий ответ (1-5 слов), без вариантов выбора
...
- НЕ используй типы: number, location, event, definition, process, person, date, term
