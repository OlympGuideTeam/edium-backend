...
type OTelConfig struct {
	...
	ServiceName string `env:"OTEL_SERVICE_NAME" envDefault:"caesar"`
}

type DoormanConfig struct {
	JWKSEndpoint string `env:"DOORMAN_JWKS_URL" envDefault:"http://doorman/doorman/.well-known/jwks.json"`
}
